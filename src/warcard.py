...
def shuffle():
	...
	root.title(f'Victors cards - {len(deck)} Cards Left')
...
def deal_cards():
	try:
		...
		if dscore.count("x") == pscore.count("x"):
			root.title(f'victors cards - Game Over! Tie! {dscore.count("x")} to {pscore.count("x")}')	
		# Dealer Wins
		elif dscore.count("x") > pscore.count("x"):
			root.title(f'victors card - Game Over! Dealer Wins! {dscore.count("x")} to {pscore.count("x")}')
		# Player Wins
		else: 
			root.title(f'victors cards - Game Over! Player Wins! {pscore.count("x")} to {dscore.count("x")}')
...
def score(dealer_card, player_card):
	...
	root.title(f'victors cards - {len(deck)} Cards Left |    Dealer: {dscore.count("x")}     Player: {pscore.count("x")}')
